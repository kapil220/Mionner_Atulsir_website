        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6  mb-8">
            {pricingFeatures.map((feature, index) => (
              <div key={index} className={`${feature.bgColor} rounded-2xl shadow-xl p-12`}>
                <div className="text-center">
                  <div className={`text-4xl font-bold ${feature.textColor} mb-4`}>
                    {feature.price}
                  </div>
          ...
          {/* Mobile App Preview */}
          <div className="fixed bottom-4 right-4 w-16 h-24 bg-white rounded-lg shadow-lg border border-gray-200 overflow-hidden">
            <div className="p-2">
              <div className="bg-gray-100 rounded mb-1">
                <div className="text-xs font-medium text-center py-1">AngelOne</div>
              </div>
